...
export const translations = {
  en: {
    ...
    work: {
      ...
      projects: [
        { title: 'AROYA Cruise', category: 'Cruise Experience', text: 'We managed the on-ground operations and guest experience for the AROYA cruise, delivering seamless organization and a professional welcome for every visitor.' },
        { title: 'Pink Cup Event', category: 'Brand Activation', text: 'We produced the Pink Cup brand activation, crafting a vibrant, photogenic space that brought the brand’s identity to life and delighted guests.' },
        { title: 'W2K23 Event', category: 'Gaming & Entertainment', text: 'We organized an immersive gaming and entertainment activation for W2K23, blending high-energy staging with interactive experiences for the crowd.' },
    ...
    contact: {
      ...
      address: 'Alitqan Square, Jeddah City – Office 510',
  ...
  ar: {
    ...
    work: {
      ...
      projects: [
        { title: 'رحلة أرويا البحرية', category: 'تجربة بحرية', text: 'أدرنا العمليات الميدانية وتجربة الضيوف لرحلة أرويا البحرية، بتنظيم سلس واستقبال احترافي لكل زائر.' },
        { title: 'فعالية بينك كب', category: 'تفعيل العلامة التجارية', text: 'نفّذنا فعالية تفعيل العلامة التجارية Pink Cup، وصمّمنا مساحة نابضة بالحياة تعكس هوية العلامة وأسعدت الضيوف.' },
        { title: 'فعالية W2K23', category: 'الألعاب والترفيه', text: 'نظّمنا تفعيلًا غامرًا للألعاب والترفيه في فعالية W2K23، مزجنا فيه بين مسرح مفعم بالطاقة وتجارب تفاعلية للجمهور.' },
    ...
    contact: {
      ...
      address: 'الإتقان سكوير، جدة – مكتب 510',
